...
4. С терминала полученные снимки отправляются на сервер, где происходит обработка снимков с помощью RetinaNet. В случае обнаружения человека координаты снимка передаются на терминал и выводятся оператору.
